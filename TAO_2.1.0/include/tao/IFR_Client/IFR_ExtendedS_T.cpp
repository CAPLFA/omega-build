...
#ifndef _TAO_IDL_IFR_EXTENDEDS_T_ZTMRN0_CPP_
#define _TAO_IDL_IFR_EXTENDEDS_T_ZTMRN0_CPP_
...
POA_CORBA::FixedDef_tie<T>::_default_POA ()
{
...
template <class T> PortableServer::POA_ptr
POA_CORBA::ValueMemberDef_tie<T>::_default_POA ()
{
  if (! ::CORBA::is_nil (this->poa_.in ()))
    {
      return ::PortableServer::POA::_duplicate (this->poa_.in ());
...
template <class T> PortableServer::POA_ptr
POA_CORBA::ValueDef_tie<T>::_default_POA ()
{
  if (! ::CORBA::is_nil (this->poa_.in ()))
    {
      return ::PortableServer::POA::_duplicate (this->poa_.in ());
...
template <class T> PortableServer::POA_ptr
POA_CORBA::ExtValueDef_tie<T>::_default_POA ()
{
  if (! ::CORBA::is_nil (this->poa_.in ()))
    {
      return ::PortableServer::POA::_duplicate (this->poa_.in ());
...
template <class T> PortableServer::POA_ptr
POA_CORBA::ValueBoxDef_tie<T>::_default_POA ()
{
  if (! ::CORBA::is_nil (this->poa_.in ()))
    {
      return ::PortableServer::POA::_duplicate (this->poa_.in ());
