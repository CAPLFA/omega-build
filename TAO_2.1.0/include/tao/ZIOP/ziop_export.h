...
#if defined (ACE_AS_STATIC_LIBS) && !defined (TAO_ZIOP_HAS_DLL)
#  define TAO_ZIOP_HAS_DLL 0
#endif /* ACE_AS_STATIC_LIBS && TAO_ZIOP_HAS_DLL */
...
// Set TAO_ZIOP_NTRACE = 0 to turn on library-specific
// tracing even if tracing is turned off for ACE.
#if !defined (TAO_ZIOP_NTRACE)
#  if (ACE_NTRACE == 1)
#    define TAO_ZIOP_NTRACE 1
#  else /* (ACE_NTRACE == 1) */
#    define TAO_ZIOP_NTRACE 0
#  endif /* (ACE_NTRACE == 1) */
#endif /* !TAO_ZIOP_NTRACE */

#if (TAO_ZIOP_NTRACE == 1)
#  define TAO_ZIOP_TRACE(X)
#else /* (TAO_ZIOP_NTRACE == 1) */
#  if !defined (ACE_HAS_TRACE)
#    define ACE_HAS_TRACE
#  endif /* ACE_HAS_TRACE */
#  define TAO_ZIOP_TRACE(X) ACE_TRACE_IMPL(X)
#  include "ace/Trace.h"
#endif /* (TAO_ZIOP_NTRACE == 1) */
