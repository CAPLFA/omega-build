...
#ifndef _TAO_PIDL_ZIOPC_OGND55_H_
#define _TAO_PIDL_ZIOPC_OGND55_H_
...
#define _ZIOP_COMPRESSIONENABLINGPOLICY__VAR_OUT_CH_
  ...
  typedef
    TAO_Objref_Var_T<
      ...
      >
    CompressionEnablingPolicy_var;
  
  typedef
    TAO_Objref_Out_T<
        CompressionEnablingPolicy
      >
    CompressionEnablingPolicy_out;
...
#define _ZIOP_COMPRESSIONLOWVALUEPOLICY__VAR_OUT_CH_
  ...
  typedef
    TAO_Objref_Var_T<
      ...
      >
    CompressionLowValuePolicy_var;
  
  typedef
    TAO_Objref_Out_T<
        CompressionLowValuePolicy
      >
    CompressionLowValuePolicy_out;
...
#define _ZIOP_COMPRESSIONMINRATIOPOLICY__VAR_OUT_CH_
  ...
  typedef
    TAO_Objref_Var_T<
      ...
      >
    CompressionMinRatioPolicy_var;
  
  typedef
    TAO_Objref_Out_T<
        CompressionMinRatioPolicy
      >
    CompressionMinRatioPolicy_out;
...
namespace ZIOP
{
  ...
  TAO_ZIOP_Export ::CORBA::Boolean operator>>= (const ::CORBA::Any &, ::ZIOP::CompressionData *&); // deprecated
