...
#ifndef _TAO_PIDL_HTIOP_HTIOP_ENDPOINTSC_ELZQ3G_H_
#define _TAO_PIDL_HTIOP_HTIOP_ENDPOINTSC_ELZQ3G_H_
...
struct HTIOP_Export HTIOP_Endpoint_Info
{
  ...
  typedef HTIOP_Endpoint_Info_out _out_type;
...
public:
  ...
  virtual ~HTIOPEndpointSequence (void);
  ...
  typedef HTIOPEndpointSequence_out _out_type;
};
...
namespace TAO
{
  ...
  template<>
  class Arg_Traits< ::HTIOP_Endpoint_Info>
    : public
  ...
  template<>
  class Arg_Traits< ::HTIOPEndpointSequence>
    : public
        Var_Size_Arg_Traits_T<
            ::HTIOPEndpointSequence,
            TAO::Any_Insert_Policy_Noop
