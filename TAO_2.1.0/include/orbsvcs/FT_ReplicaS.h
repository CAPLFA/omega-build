...
#ifndef _TAO_IDL_FT_REPLICAS_TB2PAR_H_
#define _TAO_IDL_FT_REPLICAS_TB2PAR_H_
...
#if !defined (_FT_PULLMONITORABLE__SARG_TRAITS_)
#define _FT_PULLMONITORABLE__SARG_TRAITS_

  template<>
  class  SArg_Traits< ::FT::PullMonitorable>
    : public
...
#if !defined (_FT_CHECKPOINTABLE__SARG_TRAITS_)
#define _FT_CHECKPOINTABLE__SARG_TRAITS_

  template<>
  class  SArg_Traits< ::FT::Checkpointable>
    : public
        Object_SArg_Traits_T<
...
#if !defined (_FT_UPDATEABLE__SARG_TRAITS_)
#define _FT_UPDATEABLE__SARG_TRAITS_

  template<>
  class  SArg_Traits< ::FT::Updateable>
    : public
        Object_SArg_Traits_T<
            ::FT::Updateable_ptr,
            ::FT::Updateable_var,
