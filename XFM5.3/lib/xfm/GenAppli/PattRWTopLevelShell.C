...
//##   initialize(parent, name);
//## } 
//## NAME::NAME(RWController* parent, const RWCString& name, ArgList args, Cardinal argcnt,  RWBoolean managed)
//## end pattern interface
//## begin pattern cxxclass
//##  : BASECLASS(parent, name, args, argcnt, managed)
//## end pattern cxxclass
//## begin pattern interface
//## {
//##   initialize(parent, name);
//## } 
//## NAME::NAME(const RWCString& application_name, const RWCString& application_class, Display* display, ArgList args, Cardinal argcnt, RWBoolean managed)
//## end pattern interface
//## begin pattern cxxclass
//##  : BASECLASS(application_name, application_class, display, args, argcnt, managed)
//## end pattern cxxclass
//## begin pattern interface
//## {
//##   initialize(0, application_name);
//## }
...
//## // If parent is null, pass to _FmCreate... the widget itself.
//## // 
//## begin pattern interface   
//##   Widget toplevels[1];
//##   toplevels[0] = getWidget();
//##   (void)  _FmCreate`NAME'((String) (const char*) name, parent ? parent->getWidget() : getWidget(), toplevels, 1, &widgetTable, &widgetNum, avs, NUMAVS, 0, 0, False, this);
//## }
//## end pattern interface
