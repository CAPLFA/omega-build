...
//##   NAME(RWController* parent, const RWCString& name, ArgList args, Cardinal argcnt,  RWBoolean managed = False);
//##   NAME(const RWCString& application_name, const RWCString& application_class, Display* display, ArgList args, Cardinal argcnt, RWBoolean managed = False);
